...
@onready var messages_vbox = $ChatPanel/VBoxContainer/ContentHBox/ScrollContainer/MessagesMargin/MessagesVBox
@onready var fake_input = $FakeInput
@onready var real_input = $ChatPanel/VBoxContainer/InputHBox/RealInput
@onready var send_button = $ChatPanel/VBoxContainer/InputHBox/SendButton
@onready var chat_panel = $ChatPanel
@onready var scroll_container = $ChatPanel/VBoxContainer/ContentHBox/ScrollContainer
@onready var friends_list_scroll = $ChatPanel/VBoxContainer/ContentHBox/FriendsListScroll
@onready var friends_list_vbox = $ChatPanel/VBoxContainer/ContentHBox/FriendsListScroll/FriendsListVBox
@onready var global_btn = $ChatPanel/VBoxContainer/TabContainer/GlobalBtn
@onready var local_btn = $ChatPanel/VBoxContainer/TabContainer/LocalBtn
@onready var friend_btn = $ChatPanel/VBoxContainer/TabContainer/FriendBtn
...
func _ready():
	...
	# Signal connections for UI controls are defined in the .tscn file
...
func _update_tab_visuals():
	...
	local_btn.disabled = (current_tab == "local")
...
func _on_send_pressed(text: String = ""):
	if text.strip_edges() == "":
		# If no text provided (e.g., button press), get from real_input
		text = real_input.text.strip_edges()
		if text == "":
			return
